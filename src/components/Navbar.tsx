    ...
    >
      <div className="container flex items-center justify-between h-16 md:h-20">
        <Link to="/" className="font-display text-2xl font-bold">
          <span className={showSolid ? "text-primary" : "text-primary-foreground"}>Cafe</span>
<span className={showSolid ? "text-foreground" : "text-primary-foreground/80"}> Indian Roots</span>
